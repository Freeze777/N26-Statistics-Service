 ...
 */
@Component("transactionStatisticsMapCache")
public class TransactionStatisticsMapCache implements TransactionStatisticsCache {
    ...
    public void add(Transaction transaction) {
        ...
        final Statistics statistics = concurrentHashMap.get(bucketIndex);
